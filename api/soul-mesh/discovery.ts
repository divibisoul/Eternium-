...
export function getStaticSoulMeshPeers(): SoulMeshPeer[] { return staticPeers; }

export async function registerWithN01(registration: Omit<SoulMeshPeer, 'lastSeen'|'nucleus'> & { nucleus: 'N02' }): Promise<boolean> {
