...
export const N02_PEERS = ['N01','N03','N04','N05','N06'] as const;
export interface TransportProfile { nucleus:string; transports: readonly N01Transport[]; }
export const N02_TRANSPORT_PROFILE: TransportProfile = { nucleus: NUCLEUS_ID, transports: N01_REFERENCE_TRANSPORTS };
